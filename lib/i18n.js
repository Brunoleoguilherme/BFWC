...
export const translations = {
  ...
  pt: {
    ...
    /* ── Tabs ── */
    tabProfile: 'Meu Perfil', tabChampionship: 'Campeonato', tabStats: 'Estatísticas', tabInfo: 'Informações',
    ...
    /* ── Documento com foto ── */
    docSection: 'Documento com foto',
    docTitle: 'Documento de identificação',
    docDesc: 'Anexe um documento oficial com foto (RG, CNH ou passaporte). Ele será usado apenas para validar sua identidade no dia dos jogos.',
    docChange: 'Clique para trocar o documento', docAdd: 'Clique para anexar o documento',
    docHint: 'JPG / PNG / WebP / PDF · máx. 8 MB', docAlter: 'TROCAR',
    docSent: 'Documento anexado', docView: 'Ver documento enviado',

    /* ── Autorização do responsável (menores) ── */
    guardianSection: 'Autorização do responsável — menor de 18 anos',
    guardianTitle: 'Autorização assinada do responsável legal',
    guardianDesc: 'Atletas menores de 18 anos precisam enviar a autorização assinada pelo responsável legal (participação, uso de imagem e dados). Baixe o modelo, peça a assinatura e anexe aqui.',
    guardianDeadline: 'Prazo para envio: 30/09/2026',
    guardianDownload: 'Baixar modelo (PDF)',
    guardianAdd: 'Clique para anexar a autorização assinada',
    guardianChange: 'Clique para trocar o arquivo',
    guardianHint: 'JPG / PNG / PDF · máx. 8 MB',
    guardianSent: 'Autorização enviada',
    guardianView: 'Ver arquivo enviado',
    guardianPending: 'PENDENTE',
    guardianModelFile: 'autorizacao-menor-bfwc2026-pt.pdf',
  ...
  en: {
    ...
    /* ── Tabs ── */
    tabProfile: 'My Profile', tabChampionship: 'Championship', tabStats: 'Statistics', tabInfo: 'Information',
    ...
    /* ── Photo ID document ── */
    docSection: 'Photo ID document',
    docTitle: 'Identification document',
    docDesc: 'Attach an official photo ID (passport, national ID or driver\'s license). It will be used only to verify your identity on game day.',
    docChange: 'Click to replace the document', docAdd: 'Click to attach the document',
    docHint: 'JPG / PNG / WebP / PDF · max 8 MB', docAlter: 'REPLACE',
    docSent: 'Document attached', docView: 'View uploaded document',

    /* ── Guardian authorization (minors) ── */
    guardianSection: 'Guardian authorization — under 18',
    guardianTitle: 'Signed legal guardian authorization',
    guardianDesc: 'Athletes under 18 must upload the authorization signed by their legal guardian (participation, image use and data). Download the template, have it signed and attach it here.',
    guardianDeadline: 'Upload deadline: Sep 30, 2026',
    guardianDownload: 'Download template (PDF)',
    guardianAdd: 'Click to attach the signed authorization',
    guardianChange: 'Click to replace the file',
    guardianHint: 'JPG / PNG / PDF · max 8 MB',
    guardianSent: 'Authorization uploaded',
    guardianView: 'View uploaded file',
    guardianPending: 'PENDING',
    guardianModelFile: 'autorizacao-menor-bfwc2026-en.pdf',
  ...
  es: {
    ...
    /* ── Tabs ── */
    tabProfile: 'Mi Perfil', tabChampionship: 'Campeonato', tabStats: 'Estadísticas', tabInfo: 'Información',
    ...
    /* ── Documento con foto ── */
    docSection: 'Documento con foto',
    docTitle: 'Documento de identificación',
    docDesc: 'Adjunta un documento oficial con foto (pasaporte, DNI o licencia). Se usará solo para validar tu identidad el día de los juegos.',
    docChange: 'Clic para cambiar el documento', docAdd: 'Clic para adjuntar el documento',
    docHint: 'JPG / PNG / WebP / PDF · máx. 8 MB', docAlter: 'CAMBIAR',
    docSent: 'Documento adjuntado', docView: 'Ver documento enviado',

    /* ── Autorización del responsable (menores) ── */
    guardianSection: 'Autorización del responsable — menor de 18 años',
    guardianTitle: 'Autorización firmada del responsable legal',
    guardianDesc: 'Los atletas menores de 18 años deben subir la autorización firmada por el responsable legal (participación, uso de imagen y datos). Descarga el modelo, pide la firma y adjúntala aquí.',
    guardianDeadline: 'Plazo de envío: 30/09/2026',
    guardianDownload: 'Descargar modelo (PDF)',
    guardianAdd: 'Clic para adjuntar la autorización firmada',
    guardianChange: 'Clic para cambiar el archivo',
    guardianHint: 'JPG / PNG / PDF · máx. 8 MB',
    guardianSent: 'Autorización enviada',
    guardianView: 'Ver archivo enviado',
    guardianPending: 'PENDIENTE',
    guardianModelFile: 'autorizacao-menor-bfwc2026-es.pdf',
