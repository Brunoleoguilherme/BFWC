...
export const translations = {
  ...
  pt: {
    ...
    photoDesc: 'Use uma foto nítida do seu rosto. Ela será usada na credencial do evento e no perfil público.',
    photoChange: 'Clique para alterar', photoAdd: 'Clique para adicionar foto',
    photoHint: 'JPG / PNG / WebP · máx. 5 MB', photoAlter: 'ALTERAR',
    photoTagPro: 'Foto profissional', photoTagBg: 'Fundo neutro', photoTagFace: 'Rosto centralizado',
  ...
  en: {
    ...
    photoDesc: 'Use a clear face photo. It will be used on your event credential and public profile.',
    photoChange: 'Click to change', photoAdd: 'Click to add photo',
    photoHint: 'JPG / PNG / WebP · max 5 MB', photoAlter: 'CHANGE',
    photoTagPro: 'Professional photo', photoTagBg: 'Neutral background', photoTagFace: 'Centered face',
  ...
  es: {
    ...
    photoDesc: 'Usa una foto clara de tu rostro. Se usará en la credencial del evento y perfil público.',
    photoChange: 'Clic para cambiar', photoAdd: 'Clic para agregar foto',
    photoHint: 'JPG / PNG / WebP · máx. 5 MB', photoAlter: 'CAMBIAR',
    photoTagPro: 'Foto profesional', photoTagBg: 'Fondo neutro', photoTagFace: 'Rostro centrado',
