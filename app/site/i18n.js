...
export const langs = {
  pt: {
    ...
    regDates: 'Inscrição: 07 a 12/07 (pré-inscritos) · a partir de 13/07 (aberta a todos).',
    ...
    regOpenTag: 'A partir de 13/07 · Aberto a todos',
  ...
  en: {
    ...
    regDates: 'Registration: Jul 7–12 (pre-registered) · from Jul 13 (open to all).',
    ...
    regOpenTag: 'From Jul 13 · Open to all',
  ...
  es: {
    ...
    regDates: 'Inscripción: 07 al 12/07 (pre-inscritos) · desde el 13/07 (abierta a todos).',
    ...
    regOpenTag: 'Desde el 13/07 · Abierto a todos',
